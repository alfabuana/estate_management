...
class MasterReceiptVoucher extends VerticalLayout{
	...
	void initTable() {
		...
		table.visibleColumns = ["user.username","cashBank.name","code","receiptDate","isGBCH","dueDate","isReconciled","reconciliationDate","totalAmount","isConfirmed","confirmationDate","dateCreated","lastUpdated","isDeleted","createdBy.username","updatedBy.username","confirmedBy.username"]
	...
	void initTableDetail() {
		...
		tableDetail.visibleColumns = ["receiptVoucher.id","receivable.code","code","amount","description","isConfirmed","confirmationDate","isDeleted","dateCreated","lastUpdated","createdBy.username","updatedBy.username","confirmedBy.username"]
